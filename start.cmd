...
if not exist bin\php\php.exe (
	powershell -command "& { iwr https://r.steadfast5.tk/php-7.3-download -OutFile (Invoke-WebRequest -UseBasicParsing -Uri "https://r.steadfast5.tk/php-7.3-file").Content }"
	powershell -command "Expand-Archive -Path (Invoke-WebRequest -UseBasicParsing -Uri "https://r.steadfast5.tk/php-7.3-file").Content -DestinationPath ."
)
