...
class Item {
	...
	const DYES = [
		...
		Item419::GREEN_DYE,
		Item419::COCOA_BEANS,
		Item419::LAPIS_LAZULI,
		Item419::PURPLE_DYE,
		Item419::CYAN_DYE,
		Item419::LIGHT_GRAY_DYE,
		Item419::GRAY_DYE,
		Item419::PINK_DYE,
		Item419::LIME_DYE,
		Item419::YELLOW_DYE,
		Item419::LIGHT_BLUE_DYE,
		Item419::MAGENTA_DYE,
		Item419::ORANGE_DYE,
		Item419::BONE_MEAL,
		Item419::BLACK_DYE,
	...
	private static function initCreativeItems419() {
		self::clearCreativeItems419();

		self::addCreativeItem419(Item::get(Item::WOODEN_PLANKS, 0), self::CREATIVE_GROUP_PLANKS);
		self::addCreativeItem419(Item::get(Item::WOODEN_PLANKS, 1), self::CREATIVE_GROUP_PLANKS);
		self::addCreativeItem419(Item::get(Item::WOODEN_PLANKS, 2), self::CREATIVE_GROUP_PLANKS);
		self::addCreativeItem419(Item::get(Item::WOODEN_PLANKS, 3), self::CREATIVE_GROUP_PLANKS);
		self::addCreativeItem419(Item::get(Item::WOODEN_PLANKS, 4), self::CREATIVE_GROUP_PLANKS);
		self::addCreativeItem419(Item::get(Item::WOODEN_PLANKS, 5), self::CREATIVE_GROUP_PLANKS);

		self::addCreativeItem419(Item::get(Item::COBBLESTONE_WALL, 0), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::COBBLESTONE_WALL, 1), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 2), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 3), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 4), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 5), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 6), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 7), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 8), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 9), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 10), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 11), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 12), self::CREATIVE_GROUP_WALLS);
		self::addCreativeItem419(Item::get(Item::STONE_WALL, 13), self::CREATIVE_GROUP_WALLS);

		self::addCreativeItem419(Item::get(Item::FENCE, 0), self::CREATIVE_GROUP_FENCE);
		self::addCreativeItem419(Item::get(Item::FENCE, 1), self::CREATIVE_GROUP_FENCE);
		self::addCreativeItem419(Item::get(Item::FENCE, 2), self::CREATIVE_GROUP_FENCE);
		self::addCreativeItem419(Item::get(Item::FENCE, 3), self::CREATIVE_GROUP_FENCE);
		self::addCreativeItem419(Item::get(Item::FENCE, 4), self::CREATIVE_GROUP_FENCE);
		self::addCreativeItem419(Item::get(Item::FENCE, 5), self::CREATIVE_GROUP_FENCE);
		self::addCreativeItem419(Item::get(Item::NETHER_BRICK_FENCE, 0), self::CREATIVE_GROUP_FENCE);

		self::addCreativeItem419(Item::get(Item::FENCE_GATE, 0), self::CREATIVE_GROUP_FENCEGATE);
		self::addCreativeItem419(Item::get(Item::FENCE_GATE_SPRUCE, 0), self::CREATIVE_GROUP_FENCEGATE);
		self::addCreativeItem419(Item::get(Item::FENCE_GATE_BIRCH, 0), self::CREATIVE_GROUP_FENCEGATE);        
		self::addCreativeItem419(Item::get(Item::FENCE_GATE_DARK_OAK, 0), self::CREATIVE_GROUP_FENCEGATE);
		self::addCreativeItem419(Item::get(Item::FENCE_GATE_JUNGLE, 0), self::CREATIVE_GROUP_FENCEGATE);
		self::addCreativeItem419(Item::get(Item::FENCE_GATE_ACACIA, 0), self::CREATIVE_GROUP_FENCEGATE);

		self::addCreativeItem419(Item::get(Item::COBBLESTONE_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);         
		self::addCreativeItem419(Item::get(Item::OAK_WOODEN_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::SPRUCE_WOODEN_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::BIRCH_WOODEN_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::JUNGLE_WOODEN_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::ACACIA_WOODEN_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::DARK_OAK_WOODEN_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::BRICK_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::STONE_BRICK_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::NETHER_BRICKS_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::SANDSTONE_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);       
		self::addCreativeItem419(Item::get(Item::QUARTZ_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);
		self::addCreativeItem419(Item::get(Item::RED_SANDSTONE_STAIRS, 0), self::CREATIVE_GROUP_STAIRS);

		self::addCreativeItem419(Item::get(Item::WOODEN_DOOR, 0), self::CREATIVE_GROUP_DOOR);

		self::addCreativeItem419(Item::get(Item::TRAPDOOR, 0), self::CREATIVE_GROUP_TRAPDOOR);

		self::addCreativeItem419(Item::get(Item::IRON_BARS, 0));

		self::addCreativeItem419(Item::get(Item::GLASS, 0), self::CREATIVE_GROUP_GLASS);
		self::addColoredCreativeItem419(self::STAINED_GLASS, self::CREATIVE_GROUP_GLASS);

		self::addCreativeItem419(Item::get(Item::GLASS_PANE, 0), self::CREATIVE_GROUP_GLASSPANE);
		self::addColoredCreativeItem419(self::STAINED_GLASS_PANE, self::CREATIVE_GROUP_GLASSPANE);

		self::addCreativeItem419(Item::get(Item::LADDER, 0));      

		self::addCreativeItem419(Item::get(Item::SLAB, 0), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::SLAB, 3), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::WOODEN_SLAB, 0), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::WOODEN_SLAB, 1), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::WOODEN_SLAB, 2), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::WOODEN_SLAB, 3), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::WOODEN_SLAB, 4), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::WOODEN_SLAB, 5), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::SLAB, 4), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::SLAB, 5), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::SLAB, 6), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::SLAB, 1), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::SLAB, 7), self::CREATIVE_GROUP_SLAB);

		self::addCreativeItem419(Item::get(Item::STONE_SLAB2, 0), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::STONE_SLAB2, 1), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::STONE_SLAB2, 2), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::STONE_SLAB2, 3), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::STONE_SLAB2, 4), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::STONE_SLAB2, 5), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::STONE_SLAB2, 6), self::CREATIVE_GROUP_SLAB);
		self::addCreativeItem419(Item::get(Item::STONE_SLAB2, 7), self::CREATIVE_GROUP_SLAB);

		self::addCreativeItem419(Item::get(Item::BRICKS, 0));
		self::addCreativeItem419(Item::get(Item::STONE_BRICKS, 0), self::CREATIVE_GROUP_STONEBRICK);
		self::addCreativeItem419(Item::get(Item::STONE_BRICKS, 1), self::CREATIVE_GROUP_STONEBRICK);
		self::addCreativeItem419(Item::get(Item::STONE_BRICKS, 2), self::CREATIVE_GROUP_STONEBRICK);
		self::addCreativeItem419(Item::get(Item::STONE_BRICKS, 3), self::CREATIVE_GROUP_STONEBRICK);
		self::addCreativeItem419(Item::get(Item::END_BRICKS, 0), self::CREATIVE_GROUP_STONEBRICK);
		self::addCreativeItem419(Item::get(Item::PRISMARINE_CRYSTAL, 0));

		self::addCreativeItem419(Item::get(Item::COBBLESTONE, 0));
		self::addCreativeItem419(Item::get(Item::MOSS_STONE, 0));
		self::addCreativeItem419(Item::get(Item::SANDSTONE, 0), self::CREATIVE_GROUP_SANDSTONE);
		self::addCreativeItem419(Item::get(Item::SANDSTONE, 1), self::CREATIVE_GROUP_SANDSTONE);
		self::addCreativeItem419(Item::get(Item::SANDSTONE, 2), self::CREATIVE_GROUP_SANDSTONE);
		self::addCreativeItem419(Item::get(Item::COAL_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::GOLD_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::IRON_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::EMERALD_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::DIAMOND_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::LAPIS_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::QUARTZ_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::QUARTZ_BLOCK, 1));
		self::addCreativeItem419(Item::get(Item::QUARTZ_BLOCK, 2));
		self::addCreativeItem419(Item::get(Item::SLIME_BLOCK, 0));

		self::addCreativeItem419(Item::get(Item::HAY_BALE, 0));
		self::addCreativeItem419(Item::get(Item::BONE_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::NETHER_BRICKS, 0));
		self::addCreativeItem419(Item::get(Item::RED_NETHER_BRICK, 0));

		self::addColoredCreativeItem419(Item::WOOL, self::CREATIVE_GROUP_WOOL);
		self::addColoredCreativeItem419(Item::CARPET, self::CREATIVE_GROUP_WOOLCARPET);

		self::addCreativeItem419(Item::get(Item::CLAY_BLOCK, 0), self::CREATIVE_GROUP_STAINEDCLAY);
		self::addCreativeItem419(Item::get(Item::HARDENED_CLAY, 0), self::CREATIVE_GROUP_STAINEDCLAY);
		self::addColoredCreativeItem419(Item::STAINED_CLAY, self::CREATIVE_GROUP_STAINEDCLAY);

		self::addCreativeItem419(Item::get(Item::PURPUR_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::DIRT, 0));
		self::addCreativeItem419(Item::get(Item::GRASS, 0));
		self::addCreativeItem419(Item::get(Item::PODZOL, 0));
		self::addCreativeItem419(Item::get(Item::MYCELIUM, 0));

		self::addCreativeItem419(Item::get(Item::STONE, 0), self::CREATIVE_GROUP_STONE);
		self::addCreativeItem419(Item::get(Item::STONE, 1), self::CREATIVE_GROUP_STONE);
		self::addCreativeItem419(Item::get(Item::STONE, 2), self::CREATIVE_GROUP_STONE);
		self::addCreativeItem419(Item::get(Item::STONE, 3), self::CREATIVE_GROUP_STONE);
		self::addCreativeItem419(Item::get(Item::STONE, 4), self::CREATIVE_GROUP_STONE);
		self::addCreativeItem419(Item::get(Item::STONE, 5), self::CREATIVE_GROUP_STONE);
		self::addCreativeItem419(Item::get(Item::STONE, 6), self::CREATIVE_GROUP_STONE);

		self::addCreativeItem419(Item::get(Item::IRON_ORE, 0), self::CREATIVE_GROUP_ORE);
		self::addCreativeItem419(Item::get(Item::GOLD_ORE, 0), self::CREATIVE_GROUP_ORE);
		self::addCreativeItem419(Item::get(Item::DIAMOND_ORE, 0), self::CREATIVE_GROUP_ORE);
		self::addCreativeItem419(Item::get(Item::LAPIS_ORE, 0), self::CREATIVE_GROUP_ORE);
		self::addCreativeItem419(Item::get(Item::REDSTONE_ORE, 0), self::CREATIVE_GROUP_ORE);
		self::addCreativeItem419(Item::get(Item::COAL_ORE, 0), self::CREATIVE_GROUP_ORE);
		self::addCreativeItem419(Item::get(Item::EMERALD_ORE, 0), self::CREATIVE_GROUP_ORE);

		self::addCreativeItem419(Item::get(Item::GRAVEL, 0));
		self::addCreativeItem419(Item::get(Item::SAND, 0));
		self::addCreativeItem419(Item::get(Item::SAND, 1));
		self::addCreativeItem419(Item::get(Item::CACTUS, 0));

		self::addCreativeItem419(Item::get(Item::TRUNK, 0), self::CREATIVE_GROUP_LOGS);
		self::addCreativeItem419(Item::get(Item::TRUNK, 1), self::CREATIVE_GROUP_LOGS);
		self::addCreativeItem419(Item::get(Item::TRUNK, 2), self::CREATIVE_GROUP_LOGS);
		self::addCreativeItem419(Item::get(Item::TRUNK, 3), self::CREATIVE_GROUP_LOGS);
		self::addCreativeItem419(Item::get(Item::TRUNK2, 0), self::CREATIVE_GROUP_LOGS);
		self::addCreativeItem419(Item::get(Item::TRUNK2, 1), self::CREATIVE_GROUP_LOGS);

		self::addCreativeItem419(Item::get(Item::LEAVES, 0), self::CREATIVE_GROUP_LEAVES);
		self::addCreativeItem419(Item::get(Item::LEAVES, 1), self::CREATIVE_GROUP_LEAVES);
		self::addCreativeItem419(Item::get(Item::LEAVES, 2), self::CREATIVE_GROUP_LEAVES);
		self::addCreativeItem419(Item::get(Item::LEAVES, 3), self::CREATIVE_GROUP_LEAVES);
		self::addCreativeItem419(Item::get(Item::LEAVES2, 0), self::CREATIVE_GROUP_LEAVES);
		self::addCreativeItem419(Item::get(Item::LEAVES2, 1), self::CREATIVE_GROUP_LEAVES);

		self::addCreativeItem419(Item::get(Item::SAPLING, 0), self::CREATIVE_GROUP_SAPLING);
		self::addCreativeItem419(Item::get(Item::SAPLING, 1), self::CREATIVE_GROUP_SAPLING);
		self::addCreativeItem419(Item::get(Item::SAPLING, 2), self::CREATIVE_GROUP_SAPLING);
		self::addCreativeItem419(Item::get(Item::SAPLING, 3), self::CREATIVE_GROUP_SAPLING);
		self::addCreativeItem419(Item::get(Item::SAPLING, 4), self::CREATIVE_GROUP_SAPLING);
		self::addCreativeItem419(Item::get(Item::SAPLING, 5), self::CREATIVE_GROUP_SAPLING);

		self::addCreativeItem419(Item::get(Item::SEEDS, 0), self::CREATIVE_GROUP_SEED);
		self::addCreativeItem419(Item::get(Item::PUMPKIN_SEEDS, 0), self::CREATIVE_GROUP_SEED);
		self::addCreativeItem419(Item::get(Item::MELON_SEEDS, 0), self::CREATIVE_GROUP_SEED);
		self::addCreativeItem419(Item::get(Item::BEETROOT_SEEDS, 0), self::CREATIVE_GROUP_SEED);

		self::addCreativeItem419(Item::get(Item::WHEAT, 0), self::CREATIVE_GROUP_CROP);        
		self::addCreativeItem419(Item::get(Item::APPLE, 0), self::CREATIVE_GROUP_CROP);
		self::addCreativeItem419(Item::get(Item::GOLDEN_APPLE, 0), self::CREATIVE_GROUP_CROP);
		self::addCreativeItem419(Item::get(Item::ENCHANTED_GOLDEN_APPLE, 0), self::CREATIVE_GROUP_CROP);

		self::addCreativeItem419(Item::get(Item::MELON_BLOCK, 0), self::CREATIVE_GROUP_CROP);
		self::addCreativeItem419(Item::get(Item::MELON, 0), self::CREATIVE_GROUP_CROP);
		self::addCreativeItem419(Item::get(Item::PUMPKIN, 0), self::CREATIVE_GROUP_CROP);
		self::addCreativeItem419(Item::get(Item::LIT_PUMPKIN, 0), self::CREATIVE_GROUP_CROP);

		self::addCreativeItem419(Item::get(Item::TALL_GRASS, 1), self::CREATIVE_GROUP_GRASS);
		self::addCreativeItem419(Item::get(Item::TALL_GRASS, 2), self::CREATIVE_GROUP_GRASS);
		self::addCreativeItem419(Item::get(Item::DANDELION, 0), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_POPPY), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_BLUE_ORCHID), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_ALLIUM), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_AZURE_BLUET), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_RED_TULIP), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_ORANGE_TULIP), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_WHITE_TULIP), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_PINK_TULIP), self::CREATIVE_GROUP_FLOWER);
		self::addCreativeItem419(Item::get(Item::RED_FLOWER, Flower::TYPE_OXEYE_DAISY), self::CREATIVE_GROUP_FLOWER);

		self::addCreativeItem419(Item::get(Item::DYES[0], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[1], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[2], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[3], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[4], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[5], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[6], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[7], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[8], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[9], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[10], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[11], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[12], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[13], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[14], 0), self::CREATIVE_GROUP_DYE);
		self::addCreativeItem419(Item::get(Item::DYES[15], 0), self::CREATIVE_GROUP_DYE);

		self::addCreativeItem419(Item::get(Item::VINES, 0));
		self::addCreativeItem419(Item::get(Item::WATER_LILY, 0));
		self::addCreativeItem419(Item::get(Item::DEAD_BUSH, 0));
		self::addCreativeItem419(Item::get(Item::SNOW_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::ICE, 0));
		self::addCreativeItem419(Item::get(Item::SNOW_LAYER, 0));

		self::addCreativeItem419(Item::get(Item::BROWN_MUSHROOM, 0), self::CREATIVE_GROUP_MUSHROOM);
		self::addCreativeItem419(Item::get(Item::RED_MUSHROOM, 0), self::CREATIVE_GROUP_MUSHROOM);
		self::addCreativeItem419(Item::get(Item::SUGAR_CANES, 0));
		self::addCreativeItem419(Item::get(Item::SUGAR, 0));
		self::addCreativeItem419(Item::get(Item::BONE, 0));
		self::addCreativeItem419(Item::get(Item::COBWEB, 0));
		self::addCreativeItem419(Item::get(Item::MONSTER_SPAWNER, 0));     

		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 15), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 10), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 11), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 12), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 13), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 14), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 22), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 16), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 19), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 18), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 33), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 38), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 39), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 34), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 37), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 35), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 32), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 36), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 17), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 40), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 42), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 41), self::CREATIVE_GROUP_MOBEGG);
		self::addCreativeItem419(Item::get(Item::SPAWN_EGG, 43), self::CREATIVE_GROUP_MOBEGG);

		self::addCreativeItem419(Item::get(Item::OBSIDIAN, 0));
		self::addCreativeItem419(Item::get(Item::BEDROCK, 0));
		self::addCreativeItem419(Item::get(Item::NETHERRACK, 0));
		self::addCreativeItem419(Item::get(Item::NETHER_WART_BLOCK_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::MAGMA, 0));
		self::addCreativeItem419(Item::get(Item::END_STONE, 0));

		self::addCreativeItem419(Item::get(Item::CHORUS_FLOWER, 0));
		self::addCreativeItem419(Item::get(Item::CHORUS_PLANT, 0));
		self::addCreativeItem419(Item::get(Item::SPONGE, 0));

		self::addCreativeItem419(Item::get(Item::LEATHER_CAP, 0), self::CREATIVE_GROUP_HELMET);
		self::addCreativeItem419(Item::get(Item::CHAIN_HELMET, 0), self::CREATIVE_GROUP_HELMET);
		self::addCreativeItem419(Item::get(Item::IRON_HELMET, 0), self::CREATIVE_GROUP_HELMET);
		self::addCreativeItem419(Item::get(Item::DIAMOND_HELMET, 0), self::CREATIVE_GROUP_HELMET);
		self::addCreativeItem419(Item::get(Item::GOLD_HELMET, 0), self::CREATIVE_GROUP_HELMET);

		self::addCreativeItem419(Item::get(Item::LEATHER_TUNIC, 0), self::CREATIVE_GROUP_CHESTPLATE);
		self::addCreativeItem419(Item::get(Item::CHAIN_CHESTPLATE, 0), self::CREATIVE_GROUP_CHESTPLATE);
		self::addCreativeItem419(Item::get(Item::IRON_CHESTPLATE, 0), self::CREATIVE_GROUP_CHESTPLATE);
		self::addCreativeItem419(Item::get(Item::DIAMOND_CHESTPLATE, 0), self::CREATIVE_GROUP_CHESTPLATE);
		self::addCreativeItem419(Item::get(Item::GOLD_CHESTPLATE, 0), self::CREATIVE_GROUP_CHESTPLATE);

		self::addCreativeItem419(Item::get(Item::LEATHER_PANTS, 0), self::CREATIVE_GROUP_LEGGINGS);
		self::addCreativeItem419(Item::get(Item::CHAIN_LEGGINGS, 0), self::CREATIVE_GROUP_LEGGINGS);
		self::addCreativeItem419(Item::get(Item::IRON_LEGGINGS, 0), self::CREATIVE_GROUP_LEGGINGS);
		self::addCreativeItem419(Item::get(Item::DIAMOND_LEGGINGS, 0), self::CREATIVE_GROUP_LEGGINGS);
		self::addCreativeItem419(Item::get(Item::GOLD_LEGGINGS, 0), self::CREATIVE_GROUP_LEGGINGS);

		self::addCreativeItem419(Item::get(Item::LEATHER_BOOTS, 0), self::CREATIVE_GROUP_BOOTS);
		self::addCreativeItem419(Item::get(Item::CHAIN_BOOTS, 0), self::CREATIVE_GROUP_BOOTS);
		self::addCreativeItem419(Item::get(Item::IRON_BOOTS, 0), self::CREATIVE_GROUP_BOOTS);
		self::addCreativeItem419(Item::get(Item::DIAMOND_BOOTS, 0), self::CREATIVE_GROUP_BOOTS);
		self::addCreativeItem419(Item::get(Item::GOLD_BOOTS, 0), self::CREATIVE_GROUP_BOOTS);

		self::addCreativeItem419(Item::get(Item::WOODEN_SWORD, 0), self::CREATIVE_GROUP_SWORD);
		self::addCreativeItem419(Item::get(Item::STONE_SWORD, 0), self::CREATIVE_GROUP_SWORD);
		self::addCreativeItem419(Item::get(Item::IRON_SWORD, 0), self::CREATIVE_GROUP_SWORD);
		self::addCreativeItem419(Item::get(Item::DIAMOND_SWORD, 0), self::CREATIVE_GROUP_SWORD);
		self::addCreativeItem419(Item::get(Item::GOLD_SWORD, 0), self::CREATIVE_GROUP_SWORD);

		self::addCreativeItem419(Item::get(Item::WOODEN_AXE, 0), self::CREATIVE_GROUP_AXE);
		self::addCreativeItem419(Item::get(Item::STONE_AXE, 0), self::CREATIVE_GROUP_AXE);
		self::addCreativeItem419(Item::get(Item::IRON_AXE, 0), self::CREATIVE_GROUP_AXE);
		self::addCreativeItem419(Item::get(Item::DIAMOND_AXE, 0), self::CREATIVE_GROUP_AXE);
		self::addCreativeItem419(Item::get(Item::GOLD_AXE, 0), self::CREATIVE_GROUP_AXE); 

		self::addCreativeItem419(Item::get(Item::WOODEN_PICKAXE, 0), self::CREATIVE_GROUP_PICKAXE);
		self::addCreativeItem419(Item::get(Item::STONE_PICKAXE, 0), self::CREATIVE_GROUP_PICKAXE);
		self::addCreativeItem419(Item::get(Item::IRON_PICKAXE, 0), self::CREATIVE_GROUP_PICKAXE);
		self::addCreativeItem419(Item::get(Item::DIAMOND_PICKAXE, 0), self::CREATIVE_GROUP_PICKAXE);
		self::addCreativeItem419(Item::get(Item::GOLD_PICKAXE, 0), self::CREATIVE_GROUP_PICKAXE);

		self::addCreativeItem419(Item::get(Item::WOODEN_SHOVEL, 0), self::CREATIVE_GROUP_SHOVEL);
		self::addCreativeItem419(Item::get(Item::STONE_SHOVEL, 0), self::CREATIVE_GROUP_SHOVEL);
		self::addCreativeItem419(Item::get(Item::IRON_SHOVEL, 0), self::CREATIVE_GROUP_SHOVEL);
		self::addCreativeItem419(Item::get(Item::DIAMOND_SHOVEL, 0), self::CREATIVE_GROUP_SHOVEL);
		self::addCreativeItem419(Item::get(Item::GOLD_SHOVEL, 0), self::CREATIVE_GROUP_SHOVEL);

		self::addCreativeItem419(Item::get(Item::WOODEN_HOE, 0), self::CREATIVE_GROUP_HOE);
		self::addCreativeItem419(Item::get(Item::STONE_HOE, 0), self::CREATIVE_GROUP_HOE);
		self::addCreativeItem419(Item::get(Item::IRON_HOE, 0), self::CREATIVE_GROUP_HOE);
		self::addCreativeItem419(Item::get(Item::DIAMOND_HOE, 0), self::CREATIVE_GROUP_HOE);
		self::addCreativeItem419(Item::get(Item::GOLD_HOE, 0), self::CREATIVE_GROUP_HOE);

		self::addCreativeItem419(Item::get(Item::BOW, 0));
		self::addCreativeItem419(Item::get(Item::ARROW, 0), self::CREATIVE_GROUP_ARROW);

		self::addCreativeItem419(Item::get(Item::COOKED_FISH, 0), self::CREATIVE_GROUP_COOKEDFOOD);
		self::addCreativeItem419(Item::get(Item::COOKED_FISH, 1), self::CREATIVE_GROUP_COOKEDFOOD);
		self::addCreativeItem419(Item::get(Item::CAKE, 0), self::CREATIVE_GROUP_MISCFOOD);
		self::addCreativeItem419(Item::get(Item::BREAD, 0), self::CREATIVE_GROUP_MISCFOOD);

		self::addCreativeItem419(Item::get(Item::FISHING_ROD, 0));
		self::addCreativeItem419(Item::get(Item::SNOWBALL));
		self::addCreativeItem419(Item::get(Item::SHEARS, 0));
		self::addCreativeItem419(Item::get(Item::FLINT_AND_STEEL, 0));
		self::addCreativeItem419(Item::get(Item::CLOCK, 0));
		self::addCreativeItem419(Item::get(Item::COMPASS, 0));
		self::addCreativeItem419(Item::get(Item::STICKS, 0));
		self::addCreativeItem419(Item::get(Item::BED, 0), self::CREATIVE_GROUP_BED);
		self::addCreativeItem419(Item::get(Item::TORCH, 0));

		self::addCreativeItem419(Item::get(Item::WORKBENCH, 0));
		self::addCreativeItem419(Item::get(Item::FURNACE, 0));
		self::addCreativeItem419(Item::get(Item::ANVIL, 0), self::CREATIVE_GROUP_ANVIL);
		self::addCreativeItem419(Item::get(Item::ANVIL, 4), self::CREATIVE_GROUP_ANVIL);
		self::addCreativeItem419(Item::get(Item::ANVIL, 8), self::CREATIVE_GROUP_ANVIL);
		self::addCreativeItem419(Item::get(Item::ENCHANT_TABLE, 0));
		self::addCreativeItem419(Item::get(Item::BOOKSHELF, 0));
		self::addCreativeItem419(Item::get(Item::CHEST, 0), self::CREATIVE_GROUP_CHEST);
		self::addCreativeItem419(Item::get(Item::ENDER_CHEST, 0), self::CREATIVE_GROUP_CHEST);

		self::addCreativeItem419(Item::get(Item::GLOWSTONE_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::REDSTONE_LAMP, 0)); 
		self::addCreativeItem419(Item::get(Item::SIGN, 0), self::CREATIVE_GROUP_SIGN);
		self::addCreativeItem419(Item::get(Item::PAINTING, 0));

		self::addCreativeItem419(Item::get(Item::BOWL, 0));
		self::addCreativeItem419(Item::get(Item::BUCKET, 0));
		self::addCreativeItem419(Item::get(Item::BUCKET, 1));
		self::addCreativeItem419(Item::get(Item::BUCKET, 8));
		self::addCreativeItem419(Item::get(Item::BUCKET, 10));
		// self::addCreativeItem419(Item::get(Item::STONECUTTER, 0)); // crash 1.11.0.1
		self::addCreativeItem419(Item::get(Item::END_PORTAL, 0));

		self::addCreativeItem419(Item::get(Item::COAL, 0));
		self::addCreativeItem419(Item::get(Item::COAL, 1));
		self::addCreativeItem419(Item::get(Item::DIAMOND, 0));
		self::addCreativeItem419(Item::get(Item::IRON_INGOT, 0));
		self::addCreativeItem419(Item::get(Item::GOLD_INGOT, 0));
		self::addCreativeItem419(Item::get(Item::EMERALD, 0));

		self::addCreativeItem419(Item::get(Item::QUARTZ, 0));
		self::addCreativeItem419(Item::get(Item::CLAY, 0));

		self::addCreativeItem419(Item::get(Item::STRING, 0));
		self::addCreativeItem419(Item::get(Item::FEATHER, 0));
		self::addCreativeItem419(Item::get(Item::FLINT, 0));
		self::addCreativeItem419(Item::get(Item::LEATHER, 0));     
		self::addCreativeItem419(Item::get(Item::END_ROD, 0));
		self::addCreativeItem419(Item::get(Item::PAPER, 0));

		self::addCreativeItem419(Item::get(Item::RAIL, 0), self::CREATIVE_GROUP_RAIL);
		self::addCreativeItem419(Item::get(Item::MINECART, 0), self::CREATIVE_GROUP_MINECART);

		self::addCreativeItem419(Item::get(Item::REDSTONE, 0));
		self::addCreativeItem419(Item::get(Item::REDSTONE_BLOCK, 0));
		self::addCreativeItem419(Item::get(Item::HOPPER, 0));
		self::addCreativeItem419(Item::get(Item::TNT, 0));
	}
	...
	private static function addColoredCreativeItem419($itemId, $creativeGroup) {
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_WHITE), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_ORANGE), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_MAGENTA), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_LIGHT_BLUE), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_YELLOW), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_LIME), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_PINK), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_GRAY), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_LIGHT_GRAY), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_CYAN), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_PURPLE), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_BLUE), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_BROWN), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_GREEN), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_RED), $creativeGroup);
		self::addCreativeItem419(Item::get($itemId, Block::COLOR_BLACK), $creativeGroup);
	}
	...
	public static function clearCreativeItems419() {
		Item::$creative419 = [];
	}
	...
	public static function getCreativeItems419() {
		return Item::$creative419;
	}
	...
	public static function addCreativeItem419(Item $item, $creativeGroup = self::CREATIVE_GROUP_NONE) {
		Item::$creative419[] = ['item' => Item::get($item->getId(), $item->getDamage()), 'group' => $creativeGroup];
	}
