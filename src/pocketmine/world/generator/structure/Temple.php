...
class Temple extends PopulatorObject {
	...
	public function placeObject(ChunkManager $world, $x, $y, $z, Random $random) {
		BuildingUtils::fill($world, new Vector3($x + 10, $y + 1, $z + 10), new Vector3($x - 10, $y + 2, $z - 10), Block::get(Block::AIR));
		$this->world = $world;
		$firstPos = new Vector3($x + 10, $y, $z + 10);
		$sndPos = new Vector3($x - 10, $y, $z - 10);

		for ($i = 0; $i <= 9; $i++) {
			BuildingUtils::walls($world, $firstPos->add(-$i, $i, -$i), $sndPos->add($i, $i, $i), Block::get(Block::SANDSTONE));
		}

		BuildingUtils::fill($world, new Vector3($x - 5, $y + 4, $z - 5), new Vector3($x + 5, $y + 4, $z + 5), Block::get(Block::SANDSTONE));
		BuildingUtils::fill($world, new Vector3($x - 1, $y - 11, $z - 1), new Vector3($x + 1, $y + 4, $z + 1), Block::get(Block::AIR));
		BuildingUtils::walls($world, new Vector3($x - 2, $y - 1, $z - 2), new Vector3($x + 2, $y - 8, $z + 2), Block::get(Block::SANDSTONE));
		BuildingUtils::fill($world, new Vector3($x - 9, $y, $z - 9), new Vector3($x + 9, $y, $z + 9), Block::get(Block::SANDSTONE));
...
//		LootTable::buildLootTable(new Vector3($x - 2, $y - 11, $z), LootTable::LOOT_DESERT_TEMPLE, $random);
		...
		switch ($this->direction) {
			case self::DIRECTION_PLUSX:
				...
				BuildingUtils::fill($world, new Vector3($x + 6, $y + 1, $z - 6), new Vector3($x + 9, $y + 4, $z + 6), Block::get(Block::SANDSTONE));
				BuildingUtils::fill($world, new Vector3($x + 6, $y + 1, $z - 1), new Vector3($x + 9, $y + 4, $z + 1), Block::get(Block::AIR));//this clears the entrance
			...
			case self::DIRECTION_PLUSZ:
				...
				BuildingUtils::fill($world, new Vector3($x - 6, $y + 1, $z + 6), new Vector3($x + 6, $y + 4, $z + 9), Block::get(Block::SANDSTONE));
				...
				BuildingUtils::fill($world, new Vector3($x - 1, $y + 1, $z + 6), new Vector3($x + 1, $y + 4, $z + 9), Block::get(Block::AIR));
	...
	protected function placeBlock($x, $y, $z, $id = Block::SANDSTONE, $meta = 0) {
		$this->world->setBlockIdAt($x, $y, $z, $id);
		$this->world->setBlockDataAt($x, $y, $z, $meta);
	}

	public function placeTower($x, $y, $z, $direction1 = self::DIRECTION_PLUSX, $direction2 = self::DIRECTION_PLUSZ) {
		BuildingUtils::walls($this->world, new Vector3($x + 2, $y, $z + 2), new Vector3($x - 2, $y + 8, $z - 2), Block::get(Block::SANDSTONE));
		BuildingUtils::fill($this->world, new Vector3($x + 1, $y + 1, $z + 1), new Vector3($x - 1, $y + 7, $z - 1), Block::get(Block::AIR));
		switch ($direction1) {
			case self::DIRECTION_PLUSX:
				switch ($direction2) {
					case self::DIRECTION_PLUSZ :
						...
						BuildingUtils::fill($this->world, new Vector3($x - 9, $y + 5, $z - 4), new Vector3($x - 7, $y + 7, $z - 5), Block::get(Block::SANDSTONE, 2));
						BuildingUtils::fill($this->world, new Vector3($x - 8, $y + 5, $z - 4), new Vector3($x - 8, $y + 6, $z - 5), Block::get(Block::AIR));
						break;
					case self::DIRECTION_MINZ:
						for ($zz = $z - 1; $zz <= $z; $zz++) {
							$this->placeBlock($x - 1, $y + 1, $zz);
				...
				BuildingUtils::fill($this->world, new Vector3($x - 3, $y, $z + 1 + ($direction2 === self::DIRECTION_PLUSZ ? 2 : 0)), new Vector3($x - 8, $y + 4, $z - 1 + ($direction2 === self::DIRECTION_MINZ ? -2 : 0)), Block::get(Block::SANDSTONE));
			...
			case self::DIRECTION_PLUSZ:
				switch ($direction2) {
					case self::DIRECTION_PLUSX:
						...
						BuildingUtils::fill($this->world, new Vector3($x - 4, $y + 5, $z - 9), new Vector3($x - 5, $y + 7, $z - 7), Block::get(Block::SANDSTONE, 2));
						BuildingUtils::fill($this->world, new Vector3($x - 4, $y + 5, $z - 8), new Vector3($x - 5, $y + 6, $z - 8), Block::get(Block::AIR));
						break;
					case self::DIRECTION_MINX:
						for ($xx = $x - 1; $xx <= $x; $xx++) {
							$this->placeBlock($xx, $y + 1, $z - 1);
				...
				BuildingUtils::fill($this->world, new Vector3($x + 1 + ($direction2 === self::DIRECTION_PLUSX ? 2 : 0), $y, $z - 3), new Vector3($x - 1 + ($direction2 === self::DIRECTION_MINX ? -2 : 0), $y + 4, $z - 8), Block::get(Block::SANDSTONE));
		...
		BuildingUtils::top($this->world, new Vector3($x - 1, $y + 9, $z - 1), new Vector3($x + 1, $y, $z + 1), Block::get(Block::SANDSTONE));
