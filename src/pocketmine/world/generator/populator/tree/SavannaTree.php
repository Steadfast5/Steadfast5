...
use pocketmine\level\generator\object\tree\ObjectSavannaTree;
use pocketmine\level\populator\Populator;
use pocketmine\level\ChunkManager;
use pocketmine\level\format\FullChunk;
use pocketmine\math\Vector3;
use pocketmine\utils\Random;

class SavannaTree extends Populator {
	...
	public function __construct(int $type = Sapling::ACACIA) {
		$this->type = $type;
	}
