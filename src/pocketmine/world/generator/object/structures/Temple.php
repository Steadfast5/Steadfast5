...
use pocketmine\level\generator\object\Dungeons;
...
class Temple extends Object {
	...
	public function placeObject(ChunkManager $level, $x, $y, $z, Random $random) {
		...
		Dungeons::prepareChest($x, $y - 11, $z + 2);
		Dungeons::prepareChest($x, $y - 11, $z - 2);
		Dungeons::prepareChest($x + 2, $y - 11, $z);
		Dungeons::prepareChest($x - 2, $y - 11, $z);
...
//		LootTable::buildLootTable(new Vector3($x - 2, $y - 11, $z), LootTable::LOOT_DESERT_TEMPLE, $random);
	...
	protected function getInvertedDirection(int $direction) {
		switch ($direction) {
			case self::DIRECTION_PLUSX:
