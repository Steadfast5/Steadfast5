...
class LoginPacket extends PEPacket {
	...
	private function getPlayerData($dataIndex, $isNeedVerify) {
		...
		$additionalSkinDataList = [
			'AnimatedImageData', 'CapeId', 'CapeImageHeight', 'CapeImageWidth', 'CapeOnClassicSkin', 'PersonaSkin', 'PremiumSkin', 'SkinAnimationData', 'SkinImageHeight', 'SkinImageWidth', 'SkinResourcePatch', 'PlayFabId'
		];
		$additionalSkinData = [];
